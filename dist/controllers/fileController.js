...
export function listFiles(_req, res, next) {
...
export function uploadFile(req, res, _next) {
    if (!req.file) {
...
export function downloadFile(req, res, _next) {
...
export function updateFile(req, res, next) {
    ...
    const file = req.file; // 👈 Typ festlegen
