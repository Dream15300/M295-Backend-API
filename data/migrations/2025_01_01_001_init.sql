...
-- Absence Documents (Dateiuploads)
CREATE TABLE IF NOT EXISTS absence_documents (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  absence_id INTEGER NOT NULL,
  filename TEXT NOT NULL,          -- gespeicherter Dateiname auf dem Server
  original_name TEXT NOT NULL,     -- Originalname vom Upload
  mime_type TEXT NOT NULL,
  size INTEGER NOT NULL,           -- Dateigrösse in Bytes
  uploaded_by INTEGER NOT NULL,    -- User, der hochgeladen hat
